        ...
        <div className="bg-[#002f6c] text-white p-4 sm:p-5 flex flex-wrap items-center justify-between gap-3 border-b border-[#001f4d]">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="bg-emerald-500/20 text-emerald-300 border border-emerald-400/30 text-[10px] font-extrabold px-2 py-0.5 rounded-full flex items-center gap-1">
                  ...
                  <span>Admin : {currentUser?.fullName || 'Oualid Soulimani'}</span>
                </span>
              </div>
              <p className="text-xs text-blue-200">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-2 bg-red-600 hover:bg-red-700 text-white font-bold text-xs rounded-xl flex items-center gap-1.5 transition cursor-pointer shadow-sm"
