      ...
      <div className="w-64 bg-[#002f6c] text-white flex-shrink-0 hidden md:flex flex-col shadow-xl z-20 h-screen relative">
        ...
        <div className="flex-1 overflow-y-auto py-6 px-4 space-y-1">
          ...
          >
            ...
            <span className={`px-2 py-0.5 rounded-full text-[10px] font-black ${activeTab === 'products' ? 'bg-white text-red-600' : 'bg-white/15 text-blue-200'}`}>
              {allProducts.length}
            </span>
          </button>
        ...
        <div className="bg-white border-b border-slate-200 px-4 sm:px-6 py-4 flex items-center justify-between z-10 shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            {activeTab !== 'products' && (
              <button
                onClick={() => setActiveTab('products')}
                className="px-3.5 py-2 bg-red-600 hover:bg-red-700 text-white font-bold text-xs rounded-xl flex items-center gap-1.5 transition cursor-pointer shadow-sm"
                title="Gérer ou ajouter des produits au catalogue"
              >
