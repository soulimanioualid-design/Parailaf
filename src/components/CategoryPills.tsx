  ...
  const categoryItems = [
    {
      ...
      subtitle: 'Packs & Promos',
      description: 'Tarifs préférentiels & remises immédiates',
      icon: Flame,
      badge: 'Promos',
    ...
    },
    {
      ...
      description: 'Ultra-discret, lecture en direct',
      icon: Sparkles,
      badge: 'Nouveau !',
    ...
    },
    {
      id: 'dexcom',
      title: 'Dexcom G7 & G6',
      subtitle: 'Systèmes CGM',
      description: 'Capteur ultra-fin & alertes prédictives',
      icon: Activity,
      badge: 'G7 & G6',
    ...
    {
      id: 'lecteurs',
      title: 'Lecteurs de Glycémie',
      subtitle: 'OneTouch & FreeStyle',
      description: 'OneTouch Verio Reflect® & FSL dès 250 DH',
      icon: Smartphone,
      badge: 'Dès 250 DH',
    ...
    {
      id: 'accessoires',
      title: 'Aiguilles & Soins',
      subtitle: 'BD Micro-Fine & Patchs',
      description: 'Aiguilles 32G/4mm, trousses & patchs',
      icon: Shield,
      badge: 'Dès 25 DH',
